/******/ (() => {
  ...
  \**************************/
			/***/ (
				...
				/* harmony export */ __webpack_require__.d(
					__webpack_exports__,
					{
						/* harmony export */ boxFieldActive: () =>
							/* binding */ boxFieldActive,
						/* harmony export */ cardFieldRender: () =>
							/* binding */ cardFieldRender,
						/* harmony export */ cardsMatch: () =>
							/* binding */ cardsMatch,
						/* harmony export */ visualCardField: () =>
							/* binding */ visualCardField,
						/* harmony export */
					}
				);
				/* harmony import */ var _chooseDiff__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(
						/*! ./chooseDiff */ './lib/chooseDiff.js'
					);
				/* harmony import */ var _templateEngine__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./templateEngine */ './lib/templateEngine.js'
					);
				/* harmony import */ var _gameCore__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(/*! ./gameCore */ './lib/gameCore.js');
				/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(
						/*! sweetalert2 */ './node_modules/sweetalert2/dist/sweetalert2.all.js'
					);
				/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_3___default =
					/*#__PURE__*/ __webpack_require__.n(
						sweetalert2__WEBPACK_IMPORTED_MODULE_3__
					);
				/* harmony import */ var _route__WEBPACK_IMPORTED_MODULE_4__ =
					__webpack_require__(/*! ./route */ './lib/route.js');
				...
				function cardsMatch(data) {
					const fieldFlip =
						document.querySelectorAll('.field-active');
					if (!hasFlippedCard) {
						hasFlippedCard = true;
						...
						if (
							...
							window.application.secondCard
						) {
							fieldFlip.forEach((card) =>
								card.removeEventListener(
									'click',
									_chooseDiff__WEBPACK_IMPORTED_MODULE_0__.flipCard
								)
							);
							window.application.fieldFlipConvert =
								Array.from(fieldFlip);
							window.application.diff =
								window.application.diff - 2;
							if (window.application.diff === 0) {
								...
								endTime.addEventListener(
									'click',
									(0,
									_route__WEBPACK_IMPORTED_MODULE_4__.backOnChooseDiff)()
								);
							}
						} else {
							setTimeout(() => {
  ...
  \***************************/
			/***/ (
				...
				/* harmony export */ __webpack_require__.d(
					__webpack_exports__,
					{
						/* harmony export */ boxActive: () =>
							/* binding */ boxActive,
						/* harmony export */ boxHide: () =>
							/* binding */ boxHide,
						/* harmony export */ boxNumber: () =>
							/* binding */ boxNumber,
						/* harmony export */ btnChooseDiff: () =>
							/* binding */ btnChooseDiff,
						/* harmony export */ card: () => /* binding */ card,
						/* harmony export */ creatorArrDecka: () =>
							/* binding */ creatorArrDecka,
						/* harmony export */ flipCard: () =>
							/* binding */ flipCard,
						/* harmony export */ timeBox: () =>
							/* binding */ timeBox,
						/* harmony export */
					}
				);
				...
				/* harmony import */ var _deck_generate_js__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./deck-generate.js */ './lib/deck-generate.js'
					);
				/* harmony import */ var _gameCore__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(/*! ./gameCore */ './lib/gameCore.js');
				/* harmony import */ var _templateEngine__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(
						/*! ./templateEngine */ './lib/templateEngine.js'
					);
				/* harmony import */ var _route__WEBPACK_IMPORTED_MODULE_4__ =
					__webpack_require__(/*! ./route */ './lib/route.js');
				/* harmony import */ var _cardField__WEBPACK_IMPORTED_MODULE_5__ =
					__webpack_require__(
						/*! ./cardField */ './lib/cardField.js'
					);
				/* harmony import */ var _timer__WEBPACK_IMPORTED_MODULE_6__ =
					__webpack_require__(/*! ./timer */ './lib/timer.js');
				/* harmony import */ var _res_1f0cf_png__WEBPACK_IMPORTED_MODULE_7__ =
					__webpack_require__(
						/*! ../res/1f0cf.png */ './res/1f0cf.png'
					);
				...
				const btnChooseDiff =
					document.querySelector('.btn_diff-submit');
				btnChooseDiff.addEventListener('click', (event) => {
					event.preventDefault;
					boxActive.classList.add('hide');
					_route__WEBPACK_IMPORTED_MODULE_4__.todoRender.appendChild(
						_route__WEBPACK_IMPORTED_MODULE_4__.game
					);
					_route__WEBPACK_IMPORTED_MODULE_4__.game.classList.remove(
						'hide'
					);
					btnBack = document.querySelector('.btn_diff-back');
					_route__WEBPACK_IMPORTED_MODULE_4__.game.appendChild(
						_cardField__WEBPACK_IMPORTED_MODULE_5__.boxFieldActive
					);
					...
					(0,
					_cardField__WEBPACK_IMPORTED_MODULE_5__.visualCardField)(
						window.application.takeCards
					);
				...
				boxNumber.forEach((box) => {
					box.addEventListener('click', (event) => {
						...
						boxDataSetGanerateDecka =
							_deck_generate_js__WEBPACK_IMPORTED_MODULE_1__[
								'default'
							].cards;
						window.application.status = boxDataSetStatus;
						window.application.diff = boxDataSetValue;
						window.application.generateCards =
							boxDataSetGanerateDecka;
				...
				function creatorArrDecka(n, row) {
					...
					for (let i = 0; i < n; i++) {
						temporaryStorage[i] = [
							window.application.generateCards[i],
						];
					...
					for (
						let i = 0;
						i < Math.ceil(subcardbox.length / row);
						i++
					) {
					...
					fieldActive = (0,
					_templateEngine__WEBPACK_IMPORTED_MODULE_3__['default'])(
						window.application.takeCards.map(
							_cardField__WEBPACK_IMPORTED_MODULE_5__.cardFieldRender
						)
					);
					_cardField__WEBPACK_IMPORTED_MODULE_5__.boxFieldActive.appendChild(
						fieldActive
					);
  ...
  \******************************/
			/***/ (
				...
				/* harmony import */ var _deck__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(/*! ./deck */ './lib/deck.js');

				const deck = new _deck__WEBPACK_IMPORTED_MODULE_0__[
					'default'
				]();
				deck.shuffle();
  ...
  \*************************/
			/***/ (
				...
				const logic = (window.application = {
					time: {},
					diff: {},
					status: [],
					generateCards: [],
  ...
  \**********************/
			/***/ (
				...
				/* harmony export */ __webpack_require__.d(
					__webpack_exports__,
					{
						/* harmony export */ backOnChooseDiff: () =>
							/* binding */ backOnChooseDiff,
						/* harmony export */ game: () => /* binding */ game,
						/* harmony export */ renderField: () =>
							/* binding */ renderField,
						/* harmony export */ todoRender: () =>
							/* binding */ todoRender,
						/* harmony export */
					}
				);
				...
				/* harmony import */ var _cardField__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ./cardField */ './lib/cardField.js'
					);
				/* harmony import */ var _timer__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(/*! ./timer */ './lib/timer.js');
				...
				const game = (0,
				_templateEngine__WEBPACK_IMPORTED_MODULE_1__['default'])(
					renderField()
				);
				// const game = templateEngine(renderField());
				function backOnChooseDiff() {
					game.classList.add('hide');
					_chooseDiff__WEBPACK_IMPORTED_MODULE_0__.boxActive.classList.remove(
						'hide'
					);
					window.card = document.querySelectorAll('.field-active');
					_chooseDiff__WEBPACK_IMPORTED_MODULE_0__.card.forEach(
						(el) => {
							_cardField__WEBPACK_IMPORTED_MODULE_2__.boxFieldActive.removeChild(
								el
							);
						}
					);
					_cardField__WEBPACK_IMPORTED_MODULE_2__.boxFieldActive.classList.remove(
						'box-field-active--small'
					);
					_cardField__WEBPACK_IMPORTED_MODULE_2__.boxFieldActive.classList.remove(
						'box-field-active--medium'
					...
					clearInterval(_timer__WEBPACK_IMPORTED_MODULE_3__.ticker);
					_chooseDiff__WEBPACK_IMPORTED_MODULE_0__.boxHide.classList.remove(
						'grey-focus'
					);
					_chooseDiff__WEBPACK_IMPORTED_MODULE_0__.boxHide.textContent =
						'';
				}
			...
			/***/ (
				...
				/* harmony export */ __webpack_require__.d(
					__webpack_exports__,
					{
						...
						/* harmony export */ timeInSecs: () =>
							/* binding */ timeInSecs,
						/* harmony export */ timer: () => /* binding */ timer,
						/* harmony export */
					}
				);
				/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(
						/*! sweetalert2 */ './node_modules/sweetalert2/dist/sweetalert2.all.js'
					);
				/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_0___default =
					/*#__PURE__*/ __webpack_require__.n(
						sweetalert2__WEBPACK_IMPORTED_MODULE_0__
					);
				/* harmony import */ var _chooseDiff__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./chooseDiff */ './lib/chooseDiff.js'
					);
				/* harmony import */ var _route__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(/*! ./route */ './lib/route.js');
				...
				const tick = () => {
					...
					if (secs > 0) {
						...
						endTime.addEventListener(
							'click',
							(0,
							_route__WEBPACK_IMPORTED_MODULE_2__.backOnChooseDiff)()
						);
					}
					...
					_chooseDiff__WEBPACK_IMPORTED_MODULE_1__.timeBox.textContent =
						resultTime;
				};
				window.tick = tick;
			...
			/***/ (module, __webpack_exports__, __webpack_require__) => {
				...
				var ___CSS_LOADER_URL_IMPORT_0___ = new URL(
					/* asset import */ __webpack_require__(
						/*! ./res/stratosskyengweb-mediumitalic.woff2 */ './res/stratosskyengweb-mediumitalic.woff2'
					),
				...
				___CSS_LOADER_EXPORT___.push([
					...
					{
						version: 3,
						sources: ['webpack://./style.css'],
						names: [],
						mappings:
							'AAAA,gBAAgB;;AAEhB;CACC,mBAAmB;CACnB,4DAAqE;AACtE;;AAEA;CACC,SAAS;CACT,UAAU;AACX;;AAEA;CACC,0BAA0B;AAC3B;;AAEA;CACC,eAAe;CACf,WAAW;CACX,YAAY;CACZ,aAAa;CACb,sBAAsB;CACtB,qBAAqB;CACrB,uBAAuB;CACvB,mBAAmB;CACnB,mBAAmB;AACpB;;AAEA;CACC,YAAY;CACZ,aAAa;CACb,WAAW;CACX,UAAU;CACV,mBAAmB;CACnB,mBAAmB;AACpB;;AAEA;CACC,kBAAkB;CAClB,iBAAiB;AAClB;;AAEA;CACC,WAAW;CACX,YAAY;CACZ,WAAW;CACX,UAAU;CACV,0BAA0B;CAC1B,kBAAkB;CAClB,gBAAgB;CAChB,eAAe;CACf,iBAAiB;CACjB,aAAa;CACb,mBAAmB;CACnB,kBAAkB;CAClB,cAAc;CACd,uBAAuB;AACxB;;AAEA;CACC,SAAS;CACT,aAAa;CACb,uBAAuB;CACvB,gBAAgB;AACjB;;AAEA;;CAEC,WAAW;CACX,YAAY;CACZ,WAAW;CACX,UAAU;CACV,gBAAgB;CAChB,mBAAmB;CACnB,aAAa;CACb,mBAAmB;CACnB,uBAAuB;AACxB;;AAEA;;CAEC,aAAa;CACb,mBAAmB;CACnB,uBAAuB;CACvB,gBAAgB;AACjB;;AAEA;;;CAGC,qBAAqB;CACrB,0BAA0B;CAC1B,kBAAkB;CAClB,gBAAgB;CAChB,eAAe;CACf,iBAAiB;;CAEjB,YAAY;CACZ,aAAa;CACb,uBAAuB;CACvB,mBAAmB;CACnB,kBAAkB;CAClB,2CAA2C;CAC3C,WAAW;CACX,YAAY;CACZ,YAAY;CACZ,WAAW;CACX,UAAU;CACV,mBAAmB;CACnB,mBAAmB;;AAEpB;;AAEA;CACC,kBAAkB;CAClB,WAAW;CACX,YAAY;CACZ,mBAAmB;AACpB;;AAEA;CACC,aAAa;CACb,mBAAmB;CACnB,8BAA8B;CAC9B,WAAW;AACZ;;AAEA;CACC,aAAa;CACb,mBAAmB;CACnB,uBAAuB;AACxB;;AAEA;CACC,aAAa;CACb,SAAS;CACT,iBAAiB;AAClB;;AAEA;CACC,eAAe;AAChB;;AAEA;CACC,iBAAiB;AAClB;;AAEA;CACC,0BAA0B;CAC1B,WAAW;CACX,YAAY;CACZ,WAAW;CACX,UAAU;CACV,mBAAmB;CACnB,aAAa;CACb,mBAAmB;CACnB,uBAAuB;CACvB,kBAAkB;CAClB,eAAe;CACf,mBAAmB;AACpB;;AAEA;CACC,aAAa;CACb,uBAAuB;CACvB,gBAAgB;AACjB;;AAEA;CACC,wCAAwC;AACzC;;AAEA;CACC,8CAA8C;AAC/C;;;AAGA;CACC,uCAAuC;AACxC;;AAEA;CACC,kBAAkB;CAClB,eAAe;CACf,WAAW;CACX,kBAAkB;CAClB,aAAa;CACb,eAAe;CACf,YAAY;CACZ,WAAW;CACX,aAAa;AACd;;AAEA;CACC,WAAW;CACX,aAAa;CACb,sBAAsB;AACvB;;AAEA;;CAEC,kBAAkB;CAClB,kBAAkB;CAClB,uDAAuD;CACvD,2BAA2B;AAC5B;;AAEA;CACC,eAAe;CACf,kBAAkB;CAClB,kBAAkB;CAClB,0BAA0B;CAC1B,iBAAiB;AAClB;;AAEA;CACC,yCAAyC;AAC1C;;AAEA;CACC,gCAAgC;AACjC;;AAEA;CACC,uBAAuB;AACxB;;AAEA;CACC,uBAAuB;;AAExB;;AAEA;CACC,aAAa;AACd;;AAEA;CACC,mBAAmB;AACpB;;AAEA;CACC,aAAa;CACb,kBAAkB;CAClB,sBAAsB;CACtB,sCAAsC;CACtC,WAAW;CACX,eAAe;CACf,mBAAmB;CACnB,YAAY;CACZ,mBAAmB;CACnB,mBAAmB;CACnB,cAAc;CACd,oBAAoB;CACpB,eAAe;AAChB',
						sourcesContent: [
							"@charset \"UTF-8\";\r\n\r\n@font-face {\r\n\tfont-family: SkyEng;\r\n\tsrc: url('./res/stratosskyengweb-mediumitalic.woff2') format('wolf2');\r\n}\r\n\r\n* {\r\n\tmargin: 0;\r\n\tpadding: 0;\r\n}\r\n\r\nbody {\r\n\tfont-family: SkyEng, Arial;\r\n}\r\n\r\n.content {\r\n\tposition: fixed;\r\n\twidth: 100%;\r\n\theight: 100%;\r\n\tdisplay: flex;\r\n\tflex-flow: column wrap;\r\n\talign-content: center;\r\n\tjustify-content: center;\r\n\talign-items: center;\r\n\tbackground: #004980;\r\n}\r\n\r\n.box-active {\r\n\twidth: 480px;\r\n\theight: 459px;\r\n\tleft: 272px;\r\n\ttop: 158px;\r\n\tbackground: #c2f5ff;\r\n\tborder-radius: 12px;\r\n}\r\n\r\n.box-h2 {\r\n\ttext-align: center;\r\n\tpadding-top: 52px;\r\n}\r\n\r\n.box-number {\r\n\twidth: 96px;\r\n\theight: 98px;\r\n\tleft: 587px;\r\n\ttop: 354px;\r\n\tfont-family: StratosSkyeng;\r\n\tfont-style: normal;\r\n\tfont-weight: 400;\r\n\tfont-size: 64px;\r\n\tline-height: 72px;\r\n\tdisplay: flex;\r\n\talign-items: center;\r\n\ttext-align: center;\r\n\tcolor: #0080c1;\r\n\tjustify-content: center;\r\n}\r\n\r\n.box-diffs {\r\n\tgap: 24px;\r\n\tdisplay: flex;\r\n\tjustify-content: center;\r\n\tmargin-top: 48px;\r\n}\r\n\r\n.box-diff,\r\n.box-number {\r\n\twidth: 98px;\r\n\theight: 98px;\r\n\tleft: 585px;\r\n\ttop: 354px;\r\n\tbackground: #fff;\r\n\tborder-radius: 12px;\r\n\tdisplay: flex;\r\n\tflex-direction: row;\r\n\tjustify-content: center;\r\n}\r\n\r\n.box-btn {\r\n\r\n\tdisplay: flex;\r\n\tflex-direction: row;\r\n\tjustify-content: center;\r\n\tmargin-top: 66px;\r\n}\r\n\r\n.btn_diff-submit,\r\n.btn_diff-back {\r\n\r\n\t/* Pres → Caption S */\r\n\tfont-family: StratosSkyeng;\r\n\tfont-style: normal;\r\n\tfont-weight: 400;\r\n\tfont-size: 24px;\r\n\tline-height: 32px;\r\n\r\n\t/* or 133% */\r\n\tdisplay: flex;\r\n\tjustify-content: center;\r\n\talign-items: center;\r\n\ttext-align: center;\r\n\tfont-feature-settings: 'pnum' on, 'lnum' on;\r\n\tcolor: #fff;\r\n\twidth: 246px;\r\n\theight: 50px;\r\n\tleft: 389px;\r\n\ttop: 519px;\r\n\tbackground: #7ac100;\r\n\tborder-radius: 12px;\r\n\r\n}\r\n\r\n.game-field {\r\n\tposition: relative;\r\n\twidth: 100%;\r\n\theight: 100%;\r\n\tbackground: #004980;\r\n}\r\n\r\n.box-d {\r\n\tdisplay: flex;\r\n\tflex-direction: row;\r\n\tjustify-content: space-between;\r\n\tmargin: 4px;\r\n}\r\n\r\n.box-box--active {\r\n\tdisplay: flex;\r\n\tflex-direction: row;\r\n\tjustify-content: center;\r\n}\r\n\r\n.box-numbers {\r\n\tdisplay: flex;\r\n\tgap: 24px;\r\n\tmargin-left: 24px;\r\n}\r\n\r\n.box-time {\r\n\tfont-size: 48px;\r\n}\r\n\r\n.box-sec {\r\n\tmargin-left: 18px;\r\n}\r\n\r\n.grey-focus {\r\n\tbackground-color: darkgray;\r\n\twidth: 98px;\r\n\theight: 98px;\r\n\tleft: 585px;\r\n\ttop: 354px;\r\n\tborder-radius: 12px;\r\n\tdisplay: flex;\r\n\tflex-direction: row;\r\n\tjustify-content: center;\r\n\ttext-align: center;\r\n\tfont-size: 16px;\r\n\talign-items: center;\r\n}\r\n\r\n.box-field-active {\r\n\tdisplay: grid;\r\n\tjustify-content: center;\r\n\tmargin-top: 60px;\r\n}\r\n\r\n.box-field-active--small {\r\n\tgrid-template-columns: 100px 100px 100px;\r\n}\r\n\r\n.box-field-active--medium {\r\n\tgrid-template-columns: 100px 100px 100px 100px;\r\n}\r\n\r\n\r\n.box-field-active--large {\r\n\tgrid-template-columns: repeat(6, 100px);\r\n}\r\n\r\n.field-active {\r\n\tposition: relative;\r\n\tcursor: pointer;\r\n\tcolor: #fff;\r\n\tborder-radius: 5px;\r\n\tpadding: 20px;\r\n\tfont-size: 150%;\r\n\tmargin: auto;\r\n\twidth: 75px;\r\n\theight: 100px;\r\n}\r\n\r\n.rubashka {\r\n\twidth: 96px;\r\n\theight: 133px;\r\n\tbackground-size: cover;\r\n}\r\n\r\n.card,\r\n.rubashka {\r\n\tposition: absolute;\r\n\tborder-radius: 5px;\r\n\ttransition: transform 0.6s cubic-bezier(0.4, 0, 0.2, 1);\r\n\tbackface-visibility: hidden;\r\n}\r\n\r\n.card {\r\n\tfont-size: 28pt;\r\n\ttext-align: center;\r\n\tline-height: 100px;\r\n\ttransform: rotateY(180deg);\r\n\tuser-select: none;\r\n}\r\n\r\n.field-active.flipped .rubashka {\r\n\ttransform: rotateY(180deg) rotateZ(50deg);\r\n}\r\n\r\n.field-active.flipped .card {\r\n\ttransform: rotateY(0) rotateZ(0);\r\n}\r\n\r\n.btn_diff-submit:hover {\r\n\tbackground-color: black;\r\n}\r\n\r\n.btn_diff-back:hover {\r\n\tbackground-color: black;\r\n\r\n}\r\n\r\n.hide {\r\n\tdisplay: none;\r\n}\r\n\r\n.swal2-icon-show {\r\n\tborder-color: white;\r\n}\r\n\r\n.swal2-popup {\r\n\tdisplay: none;\r\n\tposition: relative;\r\n\tbox-sizing: border-box;\r\n\tgrid-template-columns: minmax(0, 100%);\r\n\twidth: 32em;\r\n\tmax-width: 100%;\r\n\tpadding: 0 0 1.25em;\r\n\tborder: none;\r\n\tbackground: #c2f5ff;\r\n\tborder-radius: 12px;\r\n\tcolor: #545454;\r\n\tfont-family: inherit;\r\n\tfont-size: 1rem;\r\n}\r\n",
						],
						sourceRoot: '',
					},
				]);
			...
			/***/ function (module) {
				...
				(function (global, factory) {
					...
					const elementBySelector = (selectorString) => {
						...
						return container
							? container.querySelector(selectorString)
							: null;
					};
...
`;
					...
					const getFocusableElements = () => {
						const focusableElementsWithTabindex = Array.from(
							...
							.sort((a, b) => {
								const tabindexA = parseInt(
									a.getAttribute('tabindex')
								);
								const tabindexB = parseInt(
						...
						return uniqueArray(
							focusableElementsWithTabindex.concat(
					...
					const isToast = () => {
						return (
							getPopup() &&
							hasClass(getPopup(), swalClasses.toast)
						);
					};
					...
					const setInnerHtml = (elem, html) => {
						...
						if (html) {
							...
							Array.from(
								parsed.querySelector('head').childNodes
							).forEach((child) => {
								elem.appendChild(child);
							});
							Array.from(
								parsed.querySelector('body').childNodes
							).forEach((child) => {
								if (
					...
					const removeCustomClasses = (elem, params) => {
						Array.from(elem.classList).forEach((className) => {
							if (
								!Object.values(swalClasses).includes(
									className
								) &&
								!Object.values(iconTypes).includes(className) &&
								!Object.values(params.showClass).includes(
									className
								)
							) {
					...
					const applyCustomClass = (elem, params, className) => {
						...
						if (
							...
							if (
								typeof params.customClass[className] !==
									'string' &&
					...
					const stopTimerProgressBar = () => {
						...
						const timerProgressBarPercent =
							(timerProgressBarWidth /
								timerProgressBarFullWidth) *
							100;
					...
					const focusPreviousActiveElement = () => {
						if (
							globalState.previousActiveElement instanceof
							HTMLElement
						) {
...
`.replace(/(^|\n)\s*/g, '');
					...
					const addInputChangeListeners = () => {
						...
						const input = getDirectChildByClass(
							popup,
							swalClasses.input
						);
						const file = getDirectChildByClass(
							popup,
							swalClasses.file
						);
						...
						const select = getDirectChildByClass(
							popup,
							swalClasses.select
						);
						/** @type {HTMLInputElement} */
						...
						const textarea = getDirectChildByClass(
							popup,
					...
					const setupRTL = (targetElement) => {
						if (
							window.getComputedStyle(targetElement).direction ===
							'rtl'
						) {
					...
					function handleButtonsStyling(
						...
						if (params.confirmButtonColor) {
							...
							addClass(
								confirmButton,
								swalClasses['default-outline']
							);
						}
						if (params.denyButtonColor) {
							denyButton.style.backgroundColor =
					...
					function renderButton(button, buttonType, params) {
						toggle(
							button,
							params[
								`show${capitalizeFirstLetter(buttonType)}Button`
							],
							'inline-block'
						);
					...
					const renderInput = (instance, params) => {
						const popup = getPopup();
						const innerParams =
							privateProps.innerParams.get(instance);
						const rerender =
							!innerParams || params.input !== innerParams.input;
					...
					const showInput = (params) => {
						...
						const input = renderInputType[params.input](
							inputContainer,
							params
						);
						show(inputContainer);
					...
					const removeAttributes = (input) => {
						for (let i = 0; i < input.attributes.length; i++) {
							...
							if (
								!['type', 'value', 'style'].includes(attrName)
							) {
					...
					const setInputLabel = (input, prependTo, params) => {
						if (params.inputLabel) {
							...
							prependTo.insertAdjacentElement(
								'beforebegin',
								label
							);
						}
...
`;
					...
					const setContent = (icon, params) => {
						...
						if (params.iconHtml) {
							...
							oldContent = oldContent.replace(
								/ style=".*?"/g,
								''
							); // undo adjustSuccessIconBackgroundColor()
							...
							newContent = iconContent(
								defaultIconHtml[params.icon]
							);
						}
					...
					const showRelatedButton = (domCache) => {
						const buttonToReplace =
							domCache.popup.getElementsByClassName(
								domCache.loader.getAttribute(
					 ...
					 */
					const clickConfirm = () =>
						getConfirmButton() && getConfirmButton().click();

					/*
					 * Global function to click 'Deny' button
					 */
					const clickDeny = () =>
						getDenyButton() && getDenyButton().click();

					/*
					 * Global function to click 'Cancel' button
					 */
					const clickCancel = () =>
						getCancelButton() && getCancelButton().click();
					...
					const handleEnter = (instance, event, innerParams) => {
						...
						if (
							...
							event.target.outerHTML ===
								instance.getInput().outerHTML
						) {
							if (
								['textarea', 'file'].includes(innerParams.input)
							) {
					...
					const triggerClosePopup = (instance) => {
						...
						if (
							!innerParams ||
							hasClass(popup, innerParams.hideClass.popup)
						) {
							return false;
						}
					...
					function rejectPromise(error) {
						const rejectPromise =
							privateMethods.swalPromiseReject.get(this);
						handleAwaitingPromise(this);
						if (rejectPromise) {
							// Reject Swal promise
							rejectPromise(error);
					...
					function setInputDisabled(input, disabled) {
						...
						if (input.type === 'radio') {
							...
							const radios =
								radiosContainer.querySelectorAll('input');
					...
					const checkIfToastParamIsValid = (param) => {
						if (toastIncompatibleParams.includes(param)) {
							warn(
								`The parameter "${param}" is incompatible with toasts`
							);
						}
					};
					...
					const populateInputOptions = {
						...
						radio: (popup, inputOptions, params) => {
							const radio = getDirectChildByClass(
								popup,
								swalClasses.radio
							);
							inputOptions.forEach((inputOption) => {
					...
					const deny = (instance, value) => {
						...
						if (innerParams.preDeny) {
							privateProps.awaitingPromise.set(
								instance || undefined,
								true
							); // Flagging the instance as awaiting a promise so it's own promise's reject/resolve methods doesn't get destroyed until the result from this preDeny's promise is received
							...
							preDenyPromise
								...
								.catch((error) =>
									rejectWith(instance || undefined, error)
								);
						} else {
							instance.close({
								isDenied: true,
					...
					const confirm = (instance, value) => {
						...
						if (innerParams.preConfirm) {
							...
							privateProps.awaitingPromise.set(
								instance || undefined,
								true
							); // Flagging the instance as awaiting a promise so it's own promise's reject/resolve methods doesn't get destroyed until the result from this preConfirm's promise is received
					...
					const getTimerLeft = () => {
						return (
							globalState.timeout &&
							globalState.timeout.getTimerLeft()
						);
					};
					...
					const toggleTimer = () => {
						...
						return (
							timer &&
							(timer.running ? stopTimer() : resumeTimer())
						);
					};
					...
					const getSwalParams = (templateContent) => {
						...
						swalParams.forEach((param) => {
							...
							if (typeof defaultParams[paramName] === 'boolean') {
								...
								typeof defaultParams[paramName] === 'object'
							) {
					...
					const getSwalButtons = (templateContent) => {
						...
						swalButtons.forEach((button) => {
							...
							result[
								`show${capitalizeFirstLetter(type)}Button`
							] = true;
							if (button.hasAttribute('color')) {
								result[`${type}ButtonColor`] =
					 ...
					 */
					const showWarningsForAttributes = (
						el,
						allowedAttributes
					) => {
						Array.from(el.attributes).forEach((attribute) => {
							if (
								allowedAttributes.indexOf(attribute.name) === -1
							) {
								warn([
					...
					function setDefaultInputValidators(params) {
						...
						if (!params.inputValidator) {
							Object.keys(defaultInputValidators).forEach(
								(key) => {
									if (params.input === key) {
					...
					class SweetAlert {
						constructor() {
							...
							// @ts-ignore
							const promise = currentInstance._main(
						...
						_main(userParams) {
							...
							const innerParams = prepareParams(
								userParams,
								mixinParams
							);
					...
					const swalPromise = (instance, domCache, innerParams) => {
						return new Promise((resolve, reject) => {
							...
							privateMethods.swalPromiseResolve.set(
								instance,
								resolve
							);
							privateMethods.swalPromiseReject.set(
								instance,
								reject
							);
					...
					const focusButton = (domCache, innerParams) => {
						if (
							innerParams.focusDeny &&
							isVisible$1(domCache.denyButton)
						) {
						...
						if (
							...
							isVisible$1(domCache.cancelButton)
						) {
  ...
  \***********************/
			/***/ (module, __unused_webpack_exports, __webpack_require__) => {
				'use strict';
				module.exports =
					__webpack_require__.p + 'ada9f37638ce55c96516.png';

				/***/
			},

		/***/ './res/stratosskyengweb-mediumitalic.woff2':
			/*!*************************************************!*\
  !*** ./res/stratosskyengweb-mediumitalic.woff2 ***!
  \*************************************************/
			/***/ (module, __unused_webpack_exports, __webpack_require__) => {
				'use strict';
				module.exports =
					__webpack_require__.p + '9d0d5d6bb68d9ac9d811.woff2';
